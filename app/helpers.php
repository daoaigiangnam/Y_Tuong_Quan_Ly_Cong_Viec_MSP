...
function ticket_badge(string $status): string {
    $map = ['NEW'=>'primary','TRIAGED'=>'info','ASSIGNED'=>'info','IN_PROGRESS'=>'warning','WAITING_CUSTOMER'=>'secondary','PENDING_CUSTOMER'=>'secondary','PENDING_VENDOR'=>'secondary','PENDING_INTERNAL'=>'secondary','RESOLVED'=>'success','CLOSED'=>'dark','REOPENED'=>'danger'];
