...
final class ContractService
{
    ...
    private static function commitUnit(PDO $db, bool $ownsTransaction, ?string $savepoint): void
    {
        if ($ownsTransaction) {
            $db->commit();
            return;
    ...
    private static function rollbackUnit(PDO $db, bool $ownsTransaction, ?string $savepoint): void
    {
        if ($ownsTransaction) {
            if ($db->inTransaction()) {
                $db->rollBack();
